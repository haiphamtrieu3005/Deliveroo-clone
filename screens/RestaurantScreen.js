    ...
    <ScrollView>
        ...
        <View className="bg-white">
            <View className="px-4 pt-4">
                <Text className="flex-3xl font-bold ">{title}</Text>
            ...
            <TouchableOpacity className="flex-row items-center space-x-2 p-5 border-y border-gray-300">
        ...
        <View className=" pt-20 mb-3 font-bold text-xl">
          {/* <Text className="px-4 pt-6 mb-3 font-bold text-xl">ádasd</Text> */}
          {/* Dishrows */}
          {dishes.map((dish) =>(
            <DishRow
              key={dish._id}
